            ...
            <div class="report-filter">
                <form method="post" class="single_form" action="<?php echo base_url() . "index.php/" . $this->uri->segment(1, 0) . "/generate_report/" ?>">
                    <div class="start-time">
                        ...
                        <input type="text" title="<?php echo $this->config->item( 'select_daily_date','tooltip_texts'); ?>" required <?php echo (isset($start_date) ? 'value = "' . $start_date . '"' : ''); ?> id="day_pickup" name="start_date" class="datepicker datepicker_start">
