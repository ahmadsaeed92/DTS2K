            ...
            <div class="report-filter">
                <form method="post" class="" action="<?php echo base_url() . "index.php/" . $this->uri->segment(1, 0) . "/generate_report/" ?>">
                    <div class="start-time">
                        ...
                        <input type="text" title="<?php echo $this->config->item( 'yearly','tooltip_texts'); ?>" readonly required <?php echo (isset($start_date) ? 'value = "' . $start_date . '"' : ''); ?> id="year_pickup" name="start_date" class="">
