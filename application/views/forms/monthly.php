            ...
            <div class="report-filter">
                <form method="post" class="" action="<?php echo base_url() . "index.php/" . $this->uri->segment(1, 0) . "/generate_report/" ?>">
                    <div class="start-time">
                        ...
                        <input type="text" title="<?php echo $this->config->item( 'monthly','tooltip_texts'); ?>" readonly required <?php echo (isset($start_date) ? 'value = "' . $start_date . '"' : ''); ?> id="month_pickup" name="start_date" class="">
                    ...
                    <button type="submit" title="<?php echo $this->config->item( 'generate_report_button','tooltip_texts'); ?>" class="btn btn-default pull-right ">Generate Report </button>
                </form>
            </div>