...
<div class="main-container">
    ...
    <header class="header container-fluid">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 ">
            <a href="#" class="logout"><img src="<?php echo asset_url() . "images/icon-logout.png" ?>" width="19" height="18" alt="" ></a>
            <a href="#" class="pull-right logo3"><img src="<?php echo asset_url() . "images/windyslogo.png" ?>" class="img-responsive" alt="" ></a>
        </div>
    </header>
    <!-- CONTENT SECTION -->
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['greet_time']; ?></td>
                                    <td><?php echo $row['menu_time']; ?></td>
                                    <td><?php echo $row['queue1']; ?></td>
                                    <td><?php echo $row['cashier_time']; ?></td>
                                    <td><?php echo $row['queue2']; ?></td>
